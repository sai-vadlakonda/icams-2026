...
/**
 * Full-bleed hero section with real campus background.
 */
    ...
    <section className="relative flex min-h-screen items-center overflow-hidden bg-ink-950">
      ...
      <div className="container-section relative z-10 pt-28 pb-20 text-center">
        ...
        <motion.h1
          ...
          className="mx-auto mt-6 max-w-5xl text-4xl font-extrabold leading-tight text-white sm:text-6xl"
        >
          7<sup>th</sup> International Congress on{' '}
        ...
        >
          ICAMS 2026 — organized by the Department of Mechanical Engineering,
          Vardhaman College of Engineering, Hyderabad. A global platform for
          researchers, academicians, scientists, and industry professionals.
        </motion.p>
